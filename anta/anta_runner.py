...
# setup logging
setup_logging(Log.INFO, Path("ANTA/anta.log"))
...
USERNAME = "ansible"
PASSWORD = "ansible"
CATALOG_PATH = Path("ANTA/anta_catalog.yml")
INVENTORY_PATH = Path("ANTA/anta_inventory.yml")
...
try:
    inventory = AntaInventory.parse(
        INVENTORY_PATH, username=USERNAME, password=PASSWORD
    )
except Exception:
