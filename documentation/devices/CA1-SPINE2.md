...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 192.168.223.12/24 | 192.168.223.1 |
...
| ---- | -------------- | -- | ---- |
| local | 9cab332d40cc992fd7511cb3ab7682e0801db855 | - | - |
...
```eos
!
snmp-server engineID local 9cab332d40cc992fd7511cb3ab7682e0801db855
...
| --------- | --------------- | ------------ | --------- |
| CA1_SPINES | Vlan4094 | 169.254.0.0 | Port-Channel7 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | L2_CA1-LEAF1A_Ethernet2 | *trunk | *110-112,1000 | *- | *- | 1 |
| Ethernet2 | L2_CA1-LEAF1B_Ethernet2 | *trunk | *110-112,1000 | *- | *- | 1 |
| Ethernet7 | MLAG_CA1-SPINE1_Ethernet7 | *trunk | *- | *- | *MLAG | 7 |
| Ethernet8 | MLAG_CA1-SPINE1_Ethernet8 | *trunk | *- | *- | *MLAG | 7 |
...
!
interface Ethernet1
   description L2_CA1-LEAF1A_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description L2_CA1-LEAF1B_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet7
   description MLAG_CA1-SPINE1_Ethernet7
   no shutdown
   channel-group 7 mode active
!
interface Ethernet8
   description MLAG_CA1-SPINE1_Ethernet8
   no shutdown
   channel-group 7 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | L2_CA1_L3_LEAFS_IDF1_Port-Channel1 | trunk | 110-112,1000 | - | - | - | - | 1 | - |
| Port-Channel7 | MLAG_CA1-SPINE1_Port-Channel7 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel1
   description L2_CA1_L3_LEAFS_IDF1_Port-Channel1
   no shutdown
...
interface Port-Channel7
   description MLAG_CA1-SPINE1_Port-Channel7
   no shutdown
   switchport mode trunk
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.1.255.2/32 |
...
| --------- | ----------- | --- | ---- | -------- |
| Vlan110 | CA1-IDF1-Data | default | - | False |
| Vlan111 | CA1-IDF1-Voice | default | - | False |
| Vlan112 | CA1-IDF1-Guest | default | - | False |
...
| Vlan111 |  default  |  10.1.11.3/24  |  -  |  10.1.11.1  |  -  |  -  |
| Vlan112 |  default  |  10.1.12.3/24  |  -  |  10.1.12.1  |  -  |  -  |
| Vlan1000 |  default  |  10.1.100.3/24  |  -  |  10.1.100.1  |  -  |  -  |
| Vlan4093 |  default  |  169.254.1.1/31  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 169.254.1.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
router bgp 65100
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description CA1-SPINE1
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor MLAG-IPv4-UNDERLAY-PEER password 7 <removed>
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor 169.254.1.0 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 169.254.1.0 description CA1-SPINE1_Vlan4093
