...
| ---- | -------------- | -- | ---- |
| local | 52eb54ff4faf16d699f9c9b0432720729bfc1b07 | - | - |
...
```eos
!
snmp-server engineID local 52eb54ff4faf16d699f9c9b0432720729bfc1b07
...
| --------- | --------------- | ------------ | --------- |
| CA1_SPINES | Vlan4094 | 169.254.0.1 | Port-Channel7 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | L2_CA1-LEAF1A_Ethernet1 | *trunk | *110-112,1000 | *- | *- | 1 |
| Ethernet2 | L2_CA1-LEAF1B_Ethernet1 | *trunk | *110-112,1000 | *- | *- | 1 |
| Ethernet7 | MLAG_CA1-SPINE2_Ethernet7 | *trunk | *- | *- | *MLAG | 7 |
| Ethernet8 | MLAG_CA1-SPINE2_Ethernet8 | *trunk | *- | *- | *MLAG | 7 |
...
!
interface Ethernet1
   description L2_CA1-LEAF1A_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description L2_CA1-LEAF1B_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet7
   description MLAG_CA1-SPINE2_Ethernet7
   no shutdown
...
| Port-Channel7 | MLAG_CA1-SPINE2_Port-Channel7 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel7
   description MLAG_CA1-SPINE2_Port-Channel7
   no shutdown
   switchport mode trunk
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.1.255.1/32 |
...
| Vlan111 |  default  |  10.1.11.2/24  |  -  |  10.1.11.1  |  -  |  -  |
| Vlan112 |  default  |  10.1.12.2/24  |  -  |  10.1.12.1  |  -  |  -  |
| Vlan1000 |  default  |  10.1.100.2/24  |  -  |  10.1.100.1  |  -  |  -  |
| Vlan4093 |  default  |  169.254.1.0/31  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 169.254.1.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
router bgp 65100
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description CA1-SPINE2
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor MLAG-IPv4-UNDERLAY-PEER password 7 <removed>
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor 169.254.1.1 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 169.254.1.1 description CA1-SPINE2_Vlan4093
