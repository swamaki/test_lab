...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_CA1-LEAF1A_Ethernet1 | - | 10.255.255.8/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_CA1-LEAF1B_Ethernet1 | - | 10.255.255.12/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_CA1-LEAF1A_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_CA1-LEAF1B_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.1.254.5 | 65103 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - | - | - | - |
| 10.1.254.6 | 65103 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - | - | - | - |
| 10.255.255.9 | 65103 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.255.13 | 65103 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65100
   ...
   neighbor 10.1.254.5 peer group EVPN-OVERLAY-PEERS
   neighbor 10.1.254.5 remote-as 65103
   neighbor 10.1.254.5 description CA1-LEAF1A_Loopback0
   neighbor 10.1.254.6 peer group EVPN-OVERLAY-PEERS
   neighbor 10.1.254.6 remote-as 65103
   neighbor 10.1.254.6 description CA1-LEAF1B_Loopback0
   neighbor 10.255.255.9 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.9 remote-as 65103
   neighbor 10.255.255.9 description CA1-LEAF1A_Ethernet1
   neighbor 10.255.255.13 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.13 remote-as 65103
   neighbor 10.255.255.13 description CA1-LEAF1B_Ethernet1
...
ip prefix-list PL-LOOPBACKS-EVPN-OVERLAY
   seq 10 permit 10.1.255.0/24 eq 32
```
