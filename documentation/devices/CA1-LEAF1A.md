...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | L2_CA1-SPINE1_Ethernet1 | *trunk | *110-112,1000 | *- | *- | 1 |
| Ethernet2 | L2_CA1-SPINE2_Ethernet1 | *trunk | *110-112,1000 | *- | *- | 1 |
...
| Ethernet9 | CSR_Router_Test_Interface | access | 110 | - | - | - |
...
!
interface Ethernet1
   description L2_CA1-SPINE1_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description L2_CA1-SPINE2_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet6
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan1000 |  default  |  10.1.100.6/24  |  -  |  -  |  -  |  -  |
