...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 192.168.223.101/24 | 192.168.223.1 |
...
| ---- | -------------- | -- | ---- |
| local | 2667d3cda8a6f9f7d054e1a9355541c28118888f | - | - |
...
```eos
!
snmp-server engineID local 2667d3cda8a6f9f7d054e1a9355541c28118888f
...
| --------- | --------------- | ------------ | --------- |
| CA1_L3_LEAFS_IDF1 | Vlan4094 | 169.254.0.5 | Port-Channel7 |
...
| Ethernet7 | MLAG_CA1-LEAF1B_Ethernet7 | *trunk | *- | *- | *MLAG | 7 |
| Ethernet8 | MLAG_CA1-LEAF1B_Ethernet8 | *trunk | *- | *- | *MLAG | 7 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_CA1-SPINE1_Ethernet1 | - | 10.255.255.9/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_CA1-SPINE2_Ethernet1 | - | 10.255.255.11/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_CA1-SPINE1_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_CA1-SPINE2_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet7
   description MLAG_CA1-LEAF1B_Ethernet7
   no shutdown
   channel-group 7 mode active
!
interface Ethernet8
   description MLAG_CA1-LEAF1B_Ethernet8
   no shutdown
   channel-group 7 mode active
!
interface Ethernet9
...
| Port-Channel7 | MLAG_CA1-LEAF1B_Port-Channel7 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel7
   description MLAG_CA1-LEAF1B_Port-Channel7
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.1.254.5/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 10.1.253.5/32 |
| Loopback101 | DIAG_VRF_VRF_TENANT | VRF_TENANT | 10.1.101.5/32 |
...
| Vlan3100 |  VRF_TENANT  |  169.254.1.4/31  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  169.254.1.4/31  |  -  |  -  |  -  |  -  |
...
| 169.254.1.5 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 169.254.1.5 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF_TENANT | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 110 | 10.1.254.5:10110 | 10110:10110 | - | - | learned |
| 111 | 10.1.254.5:10111 | 10111:10111 | - | - | learned |
| 112 | 10.1.254.5:10112 | 10112:10112 | - | - | learned |
| 3401 | 10.1.254.5:13401 | 13401:13401 | - | - | learned |
| 3402 | 10.1.254.5:13402 | 13402:13402 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| VRF_TENANT | 10.1.254.5:101 | connected | - |
...
router bgp 65103
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description CA1-LEAF1B
   ...
   neighbor 10.255.255.8 description CA1-SPINE1_Ethernet1
   neighbor 10.255.255.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.10 remote-as 65100
   neighbor 10.255.255.10 description CA1-SPINE2_Ethernet1
   neighbor 169.254.1.5 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 169.254.1.5 description CA1-LEAF1B_Vlan4093
   ...
   vrf VRF_TENANT
      ...
      router-id 10.1.254.5
      neighbor 169.254.1.5 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 169.254.1.5 description CA1-LEAF1B_Vlan3100
...
| -------------- | ----------------------- | ----------------------- |
| VRF_TENANT | 10.1.101.5 | - |

### Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf VRF_TENANT address 10.1.101.5
```
